...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('subcategories', '0002_rename_subcategori_user_id_91f25e_idx_sub_categor_user_id_b5f1c9_idx_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_category', models.ForeignKey(help_text='Parent user category', on_delete=django.db.models.deletion.CASCADE, related_name='subcategories', to='endusers.usercategories')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user_id', 'user_category'], name='sub_categor_user_id_a9d52b_idx'),
        ),
        migrations.AddIndex(
            model_name='subcategory',
